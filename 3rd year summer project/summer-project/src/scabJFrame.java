 ...
 * @author User
 */
public class scabJFrame extends javax.swing.JFrame {

    /**
     * Creates new form scabJFrame
     */
    public scabJFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/scab_1_520x480.jpg"))); // NOI18N
        ...
        jTextArea1.setText("scab is the most common disease . Scab is\ncaused by a fungus that infects both leaves and\nfruit.Scabby fruit are often unfit for eating. \nInfected leaves have olive green to brown spots.");
        jScrollPane1.setViewportView(jTextArea1);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 140, 360, 130));
        ...
        jTextArea2.setText("Apple scab is treated by the fungicide portion\nof an all-purpose fruit tree spray, not the\ninsecticide portion, so a fungicide-only spray is \nall you need.");
        jScrollPane2.setViewportView(jTextArea2);

        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 340, 360, 130));

        jLabel4.setFont(new java.awt.Font("Microsoft JhengHei UI Light", 0, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Scab");
