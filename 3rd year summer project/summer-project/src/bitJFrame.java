 ...
 * @author User
 */
public class bitJFrame extends javax.swing.JFrame {

    /**
     * Creates new form bitJFrame
     */
    public bitJFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Bitterpit_1_520x480.jpg"))); // NOI18N
        ...
        jTextArea1.setText("Bitter pit is a disorder, not a disease. It is\ncaused by low levels of calcium in the fruit\nand it is more common after hot, dry \nsummers. It can usually be reduced or, \nsometimes, prevented with good \ncultivation practices.");
        jScrollPane1.setViewportView(jTextArea1);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 130, 300, 140));
        ...
        jTextArea2.setText("to treat such disease you must spray the \nfruits using a calcium spray, like 'foliar'\nspray. ");
        jScrollPane2.setViewportView(jTextArea2);

        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 380, 300, 110));

        jLabel4.setFont(new java.awt.Font("Microsoft JhengHei UI Light", 0, 18)); // NOI18N
        jLabel4.setText("Bitter Pit");
